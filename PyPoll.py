...
# Declare new list of Candidate Options
candidate_options = []
...
#Declare variable that holds empty string value for winning candidate
winning_candidate = ""
#Declare variable for the 'winning count'equal to zero
winning_count = 0
#Declare variable for the 'winning percentage' equal to zero
